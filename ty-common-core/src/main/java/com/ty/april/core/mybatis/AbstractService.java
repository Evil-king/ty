...
import com.ty.april.common.tool.constants.Constants;
import com.ty.april.common.tool.page.MyPageInfo;
import com.ty.april.common.tool.page.PageParam;
import com.ty.april.common.tool.page.PageUtil;
...
public abstract class AbstractService<T> implements Service<T> {
    ...
    @Override
    public boolean updateNull(T model) {
    ...
    public void batchDelete(Iterable<String> idSet) {
        Condition condition = new Condition(modelClass);
        condition.createCriteria().andIn("id", idSet);
        softDelete(condition);
    }

    @Override
    public void batchDelete2(Iterable<Long> ids) {
        Condition condition = new Condition(modelClass);
    ...
    @Override
    public Boolean repeatVerification(String fieldName, Object fieldValue, Long id) {
        Condition condition = new Condition(modelClass);
