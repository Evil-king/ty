...
public final class ApiResult<T> implements Serializable {
     ...
     * @return
     */
    public static <T> ApiResult<T> build(ResultEnum resultEnum, T data) {
     ...
     * @return
     */
    public static <T> ApiResult<T> build(ApiResult oldApiResult) {
        return new ApiResult<>(oldApiResult.getCode(), oldApiResult.getMsg(), null);
    }
    ...
    /**
     * 是否失败，true表示失败，false表示成功
     *
     * @return
     */
    public boolean hasFail() {
        return this.code == null || ResultEnum.SUCCESS.getCode() != this.code.intValue();
    }
     ...
     * @return
     */
    public static ApiResult successWithEmptyList() {
        return new ApiResult<>(ResultEnum.SUCCESS.getCode(), ResultEnum.SUCCESS.getMsg(), new ArrayList<>());
    }
     ...
     * @return
     */
    public static <T> ApiResult<T> serviceFail(String msg) {
        return new ApiResult<>(ResultEnum.SERVIE_FAIL.getCode(), msg, null);
    }
     ...
     * @return
     */
    public static <T> ApiResult<T> repeatSubmit() {
        return new ApiResult<>(ResultEnum.REPEAT_SUBMIT.getCode(), ResultEnum.REPEAT_SUBMIT.getMsg(), null);
    }
